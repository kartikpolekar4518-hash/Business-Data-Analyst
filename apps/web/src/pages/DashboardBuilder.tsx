...
export default function DashboardBuilder() {
  ...
  const renderBody = (item: WidgetItem) => {
    ...
    if (!visual?.builder) return <p className="py-6 text-center text-sm text-ink-faint">This widget is no longer available.</p>;
    ...
    return visual.builder.render(ctx) ?? <p className="py-6 text-center text-sm text-ink-faint">No data for this visual yet.</p>;
  };
