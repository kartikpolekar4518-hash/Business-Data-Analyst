  ...
  return (
    <div className="grid min-h-full lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-[#0a0f1a] p-12 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-2"><div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-brand-400 to-brand-600 shadow-lg shadow-brand-500/40"><BrainCircuit className="h-5 w-5" /></div><span className="text-xl font-bold">NoPS</span></div>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-sm rounded-2xl border border-border bg-white/70 p-7 shadow-card backdrop-blur-sm dark:border-white/[0.06] dark:bg-slate-900/60 dark:shadow-card-glow">
          <div className="mb-6 flex items-center gap-2 lg:hidden"><div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-brand-400 to-brand-600 text-white"><BrainCircuit className="h-5 w-5" /></div><span className="text-lg font-bold">NoPS</span></div>
